...
class TransStrings
{
    ...
    public static function getStrings()
    {
        return array(
            ...
            'Maximum allowed is'                                                               => __('Maximum allowed is', 'fluent-booking'),
            'Minimum value is 0'                                                               => __('Minimum value is 0', 'fluent-booking'),
            ...
            'McpSettings/app_password_hint'                                                    => __('Authenticate with a WordPress application password for the account the agent should act as.', 'fluent-booking'),
            ...
            'Adapter Required'                                                                 => __('Adapter Required', 'fluent-booking'),
            'Adapter Inactive'                                                                 => __('Adapter Inactive', 'fluent-booking'),
            ...
            'No MCP adapter found'                                                             => __('No MCP adapter found', 'fluent-booking'),
            'Enable the FluentBooking MCP server'                                              => __('Enable the FluentBooking MCP server', 'fluent-booking'),
            'What a connected client can do'                                                   => __('What a connected client can do', 'fluent-booking'),
            'Endpoint URL'                                                                     => __('Endpoint URL', 'fluent-booking'),
            'Copy endpoint URL'                                                                => __('Copy endpoint URL', 'fluent-booking'),
            'Create one on your profile'                                                       => __('Create one on your profile', 'fluent-booking'),
