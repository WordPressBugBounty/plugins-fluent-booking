                           ...
                           href="<?php echo esc_url($fluentBookingEvent->public_url); ?>" class="fcal_card fcal_event_card">
                                ...
                                <div class="fcal_slot_items_wrap">
                                    ...
                                    <?php if ($fluentBookingEvent->event_time) { ?>
                                        <span class="fcal_slot_time">
                                            ...
                                            <?php echo esc_html(\FluentBooking\App\Services\DateTimeHelper::getFormattedEventTime($fluentBookingEvent->event_time)); ?>
                                        </span>
                                    <?php } ?>
                                </div>
                            </div>
                            <button class="book_now">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                                    <path d="M12.025 5.44167L17.0833 10.5L12.025 15.5583" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M2.91666 10.5H16.9417" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </button>
                        </a>
                    </div>
