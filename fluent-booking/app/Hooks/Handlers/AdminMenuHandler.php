...
JS;
    ...
    public function enqueueAssets()
    {
        ...
        if ($isRtl) {
            Vite::enqueueStyle('fluentbooking_admin_rtl', 'admin_rtl_css', [], $assetsVersion);
        }
        ...
        Vite::enqueueScript($slug . '_global_admin', 'global_admin', array(), $assetsVersion);
    ...
    public static function getCalendarSettingsMenuItems($calendar)
    {
        return apply_filters('fluent_booking/calendar_setting_menu_items', [
            ...
            'calendar_events'   => [
                ...
                'label'   => __('Event Types', 'fluent-booking'),
