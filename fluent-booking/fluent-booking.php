...
define('FLUENT_BOOKING_VERSION', '2.5.0');
define('FLUENT_BOOKING_DB_VERSION', '1.0.2');
define('FLUENT_BOOKING_ASSETS_VERSION', '2.5.0');
define('FLUENT_BOOKING_MIN_PRO_VERSION', '2.5.0');
